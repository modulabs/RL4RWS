...
#ifdef STM303
		ADC_InitTypeDef       ADC_InitStructure; //103

		RCC_ADCCLKConfig(RCC_ADC34PLLCLK_Div2); //103
		RCC_AHBPeriphClockCmd(RCC_AHBPeriph_ADC34, ENABLE); //103

		ADC_InitStructure.ADC_AutoInjMode = ADC_AutoInjec_Disable; //103
